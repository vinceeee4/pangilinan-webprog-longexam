const products = [
  ...
  {
    name: 'bulldogs-plushie',
    title: 'Bulldogs Plushie',
    category: 'Merchandise',
    price: 'PHP 399',
    stock: 'In stock',
    image: '/plushie.jpg',
    content: [
      'An adorable and huggable Bulldogs mascot plushie, perfect for fans and collectors.',
      'Soft, high-quality fabric with embroidered details and vibrant colors.',
      'Makes a great gift, room decoration, or collectible item for campus pride.',
    ],
  },
  {
