          ...
          <div className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-5">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                <img src="/totebag.jpg" alt="Category 1" className="h-full w-full object-cover" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                <img src="/tumbler.png" alt="Category 2" className="h-full w-full object-cover" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                <img src="/hoodie.jpg" alt="Category 3" className="h-full w-full object-cover" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                <img src="/lanyard.jpg" alt="Category 4" className="h-full w-full object-cover" />
              </div>
            </div>
