                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                            <img src="/totebag.jpg" alt="Daily Essentials" className="h-full w-full object-cover" />
                        </div>
                    ...
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                            <img src="/stickynotes.jpg" alt="Study Supplies" className="h-full w-full object-cover" />
                        </div>
                    ...
                    <article className="rounded-3xl border-2 border-zinc-900 bg-zinc-100 p-4">
                        <div className="flex aspect-4/3 items-center justify-center rounded-[1.25rem] bg-zinc-200 overflow-hidden">
                            <img src="/aparell.jpg" alt="Campus Apparel" className="h-full w-full object-cover" />
                        </div>
